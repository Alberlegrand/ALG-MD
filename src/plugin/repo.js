...
const handleRepoCommand = async (m, Matrix) => {
  const repoUrl = 'https://api.github.com/repos/Alberlegrand/ALG-MD';
  try {
    ...
    const messageText = `Hello *_${m.pushName}_,*\nThis is *ALG-MD,* A Whatsapp Bot Built by *HAITIAN IT Group,* Enhanced with Amazing Features to Make Your Whatsapp Communication and Interaction Experience Amazing\n\n*❲❒❳ ɴᴀᴍᴇ:* ${name}\n*❲❒❳ sᴛᴀʀs:* ${stargazers_count}\n*❲❒❳ ғᴏʀᴋs:* ${forks_count}\n*❲❒❳ ᴄʀᴇᴀᴛᴇᴅ ᴏɴ:* ${new Date(created_at).toLocaleDateString()}\n*❲❒❳ ʟᴀsᴛ ᴜᴘᴅᴀᴛᴇᴅ:* ${new Date(updated_at).toLocaleDateString()}`;
              ...
              buttons: [
                ...
                },
                {
                  ...
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: `https://whatsapp.com/channel/0029VaDAkV9FHWqAMMHvb40b`
                  })
                },
                {
                  name: "cta_url",
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: `https://github.com/Alberlegrand/ALG-MD/fork`
                  })
                }
              ],
            }),
